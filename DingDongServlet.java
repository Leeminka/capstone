...
public class DingDongServlet extends BaseServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		System.out.println("DeviceIddddddddddddddddddddddddddddd"+pId);
		...
		try {
			...
			String select = "Select * from User_Information where DeviceId='"+pId+"'";
